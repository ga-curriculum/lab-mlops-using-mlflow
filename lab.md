...
- **Section C: Testing the Deployment (5 minutes)**
    ...
    - **Instructions:**
        ...
        2.  **Test the Deployment (from Jupyter Notebook or the Terminal):**
            ...
            ```python
            # Cell 7: Testing with curl

            # The example data below is ALREADY one-hot encoded to match the preprocessing in train.py.

            # Corrected curl command (in Jupyter Notebook or terminal)
